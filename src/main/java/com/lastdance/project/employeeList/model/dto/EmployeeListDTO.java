package com.lastdance.project.employeeList.model.dto;
...
public class EmployeeListDTO {
    ...
    private double total_salary;    //총 급여
    private String dept_name;       //직책
    ...
    public EmployeeListDTO(int member_no, int salary, double bonus, double total_salary, String dept_name, String name, String id, String password, RoleType role_type, String birth_date, String phone, String address, String enroll_date) {
